open class Graph<VertexType> {
    protected var vertices: MutableSet<VertexType> = mutableSetOf()
    protected var edges: MutableMap<VertexType, MutableSet<VertexType>> = mutableMapOf()
